...
internal static class OdcsDocumentMapper
{
    ...
    {
        var infoElement = TryGetCustomPropertyValue(root, "fciInfo");
        var freshnessElement = TryGetCustomPropertyValue(root, "fciFreshness");
        var qualityElement = TryGetCustomPropertyValue(root, "fciQuality");
