...
Automated coverage:
- `frontend/e2e/workload.spec.ts` runs standalone Chromium coverage for no-blank-page bootstrap, list/editor rendering, Monaco, routing, theme, correlation headers, bundle secret scan, startup performance, and mocked Fabric proxy lakehouse/table pickers.
