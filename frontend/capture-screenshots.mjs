...
const MOCK_CONTRACTS = [
  ...
  },
  {
    ...
    targetTablePath: 'fabric://finance-workspace/FinanceWarehouse/dbo/transactions',
  ...
  },
  {
    ...
    name: 'IoT Sensor Readings Contract',
    version: '1.0.0',
    status: 'active',
    ownerEmail: 'iot-ops@orqentis.com',
    targetType: 'eventhouse',
    targetItemId: 'eh-001',
    targetTablePath: 'fabric://iot-workspace/IoTEventhouse/sensor_telemetry',
  ...
  },
  {
    ...
    version: '2.0.0',
    status: 'active',
    ownerEmail: 'bi-team@orqentis.com',
    targetType: 'semantic-model',
    targetItemId: 'sm-001',
    targetTablePath: 'fabric://sales-workspace/SalesAnalyticsModel/FactSales',
