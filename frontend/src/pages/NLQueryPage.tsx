...
export function NLQueryPage() {
  ...
  return (
    <ItemEditor
      ...
      subtitle="Ask in plain English — owners, failures, sensitive data, SLAs — and jump to the contracts that answer it."
    ...
    >
      <div className={styles.root}>
        ...
        <Field
          ...
          label={result ? 'Natural-language query' : undefined}
        >
          <Input
            size="large"
        ...
        {result ? (
          <Card className={styles.resultCard}>
            <div className={styles.resultHeader}>
              ...
              {isFallbackModel(result.modelUsed) ? (
                <Badge appearance="outline">Heuristic result</Badge>
              ) : null}
            </div>
